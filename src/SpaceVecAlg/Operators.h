...
PTransform<T>::angularMul(const MotionVec<T> &mv) const {
  using namespace Eigen;
...
template <typename T>
inline Eigen::Vector3<T>
PTransform<T>::linearMul(const MotionVec<T> &mv) const {
  using namespace Eigen;
  const Matrix3<T> &E = rotation();
...
template <typename T>
inline Eigen::Vector3<T>
PTransform<T>::angularInvMul(const MotionVec<T> &mv) const {
  using namespace Eigen;
  const Matrix3<T> &E = rotation();
...
template <typename T>
inline Eigen::Vector3<T>
PTransform<T>::linearInvMul(const MotionVec<T> &mv) const {
  using namespace Eigen;
  const Matrix3<T> &E = rotation();
  const Vector3<T> &r = translation();
...
template <typename T>
inline Eigen::Vector3<T>
PTransform<T>::coupleDualMul(const ForceVec<T> &fv) const {
  using namespace Eigen;
  const Matrix3<T> &E = rotation();
  const Vector3<T> &r = translation();
...
template <typename T>
inline Eigen::Vector3<T>
PTransform<T>::forceDualMul(const ForceVec<T> &fv) const {
  using namespace Eigen;
  const Matrix3<T> &E = rotation();
...
template <typename T>
inline Eigen::Vector3<T>
PTransform<T>::coupleTransMul(const ForceVec<T> &fv) const {
  using namespace Eigen;
  const Matrix3<T> &E = rotation();
  const Vector3<T> &r = translation();
...
template <typename T>
inline Eigen::Vector3<T>
PTransform<T>::forceTransMul(const ForceVec<T> &fv) const {
  using namespace Eigen;
  const Matrix3<T> &E = rotation();
